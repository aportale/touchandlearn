...
?>
				<h2><?=text('Status', 'Status')?></h2>
					<?=text('<p>The progam Touch\'n\'learn was developed in 1998 in Turbo Delphi 1.0 for Windows 3.1.</p>'.
							...
							'<p>2007 veröffentlichte ich es auf SourceForge und passte den Quelltext an, um ihn unter Turbo Delphi 2006 Express kompilierbar zu machen. Ich hatte vor, Touch\'n\'learn anschließend auf das quelloffene und plattformunabhängige <a href="http://www.lazarus.freepascal.org/">Free Pascal Lazarus</a> zu portieren. Dann stellte ich fest, dass Lazarus -anders als Delphi- keine Werkzeuge zum Laden und Zeichnen von Vektorgrafik hat.</p>'.
							...
							'<p>Sollte es genug Interesse an dem Projekt würde ich sehr gerne etwas neues, besseres und größeres kreieren. Kontaktieren Sie mich einfach auf der SourceForge-seite.</p>')?>
<?
			break;
			case 'license':
?>
...
?>
				...
				<?=text('<p>An educative software for physically challenged children which is completely usable with a touch screen. The elements of the user interface are big and clear.</p>'.
						...
						'<p>Ein Lernprogramm für körperlich behinderte Grundschulkinder, das für die Benutzung mit einem Touchscreen geeignet ist. Die Bedienelemente sind groß und deutlich.</p>'.
